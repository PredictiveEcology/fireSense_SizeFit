...
----|:--------------|---------------------------------------------------------------------
`formula`|`list(beta = ~1,`<br>&emsp;&emsp;&emsp;`theta = ~1)`|a named list with two elements, 'beta' and 'theta', describing the model to be fitted. 'beta' and 'theta' should be formulas (see `?formula`).
