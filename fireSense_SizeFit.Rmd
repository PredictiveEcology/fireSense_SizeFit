...
`link`|`list(beta = "log",`<br>`theta = "identity")`|a named `list` with two components called **beta** and **theta** specifying model links for the $\beta$ and $\theta$ parameters of the tapered Pareto. These can be `character strings` or objects of class `link-glm`. For more additional details see `?family`.
